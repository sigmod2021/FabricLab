...
THIRDPARTY_IMAGES=(fabric-kafka fabric-zookeeper fabric-baseos)
...
docker pull sigmod/streamchain-ccenv:latest
docker pull sigmod/streamchain-kafka:latest
docker pull sigmod/streamchain-orderer:latest
docker pull sigmod/streamchain-peer:latest
docker pull sigmod/streamchain-tools:latest
