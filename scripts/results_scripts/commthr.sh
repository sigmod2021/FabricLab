...
for l in 300 
do
 sed -i "23s/.*/        tps: ${l}/" /home/ubuntu/FabricLab/inventory/blockchain/benchmark/${chaincode[${i}]}/config.yaml
#5.txduration
for m in 180 
do
 sed -i "19s/.*/    - ${m}/" /home/ubuntu/FabricLab/inventory/blockchain/benchmark/${chaincode[${i}]}/config.yaml
#6. BlockSize
...
for Z in 0
do
 sed -i "s/^fabric_state_db: .*$/fabric_state_db: ${R[${Z}]}/" /home/ubuntu/FabricLab/inventory/blockchain/group_vars/blockchain-setup.yaml
 #Z=0
