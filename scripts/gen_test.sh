...
for l in 100
do
 sed -i "23s/.*/        tps: ${l}/" /home/ubuntu/FabricLab/inventory/blockchain/benchmark/generator/config.yaml
#5.txduration
for m in 180 
do
 sed -i "19s/.*/    - ${m}/" /home/ubuntu/FabricLab/inventory/blockchain/benchmark/generator/config.yaml
#6. BlockSize
for n in 100
do
