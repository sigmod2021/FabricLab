...
3. Clone the repository:
    * `git clone https://github.com/sigmod2021/FabricLab.git`
    * `cd FabricLab`
...
3. Setup kubernetes cluster
    ...
    * Edit file [openstack_instance.py](../openstack_infra/roles/os_instance/files/openstack_instance.py) at line 226 and add current location of openstackall.crt
        * sess = session.Session(auth=auth, verify='/home/ubuntu/FabricLab/openstackall.crt')
...
* Use the files in the folder FabricLab/editedcaliperfiles to extend the metrics collection to include transaction failures and to use the workload generator with caliper.

Integrating Fabric++, Streamchain and FabricSharp with FabricLab
-----
...
* The docker images will have to be built separately. Mock dockerhub repository used to protect double blind policy.
