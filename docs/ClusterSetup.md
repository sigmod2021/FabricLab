...
* This [customised version](https://github.com/anon/kubespray/tree/sk_2.6.0_xenial) of kubespray is used in this project: Official version `v2.6.0` is customised for ubuntu xenial.
...
- Documentation can be found [here](https://github.com/anon/kubespray/blob/sk_2.6.0_xenial/docs/vars.md)
