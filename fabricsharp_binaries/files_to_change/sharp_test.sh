...
rm -rf /home/ubuntu/FabricLab/log/
rm /home/ubuntu/FabricLab/ansible.log
rm -rf node_modules/
...
do
  ...
  #cp /home/ubuntu/FabricLab/inventory/blockchain/group_vars/${usecase[${i}]}.yaml /home/ubuntu/FabricLab/inventory/blockchain/group_vars/blockchain-setup.yaml
...
for l in 10 50 100 
do
 sed -i "23s/.*/        tps: ${l}/" /home/ubuntu/FabricLab/inventory/blockchain/benchmark/electronic-health-record/config.yaml
#5.txduration
for m in 180 
do
 sed -i "19s/.*/    - ${m}/" /home/ubuntu/FabricLab/inventory/blockchain/benchmark/electronic-health-record/config.yaml
#6. BlockSize
for n in 10 50 100
do
 sed -i "s/^fabric_batchsize: .*$/fabric_batchsize: [\"${n}\", \"2 MB\", \"2 MB\"]/" /home/ubuntu/FabricLab/inventory/blockchain/group_vars/blockchain-setup.yaml
#7.NumOfOrgs
for o in 2
do
 sed -i "s/^fabric_num_orgs: .*$/fabric_num_orgs: ${o}/" /home/ubuntu/FabricLab/inventory/blockchain/group_vars/blockchain-setup.yaml
#8.PeersPerOrg
for p in 2
do
 sed -i "s/^fabric_peers_per_org: .*$/fabric_peers_per_org: ${p}/" /home/ubuntu/FabricLab/inventory/blockchain/group_vars/blockchain-setup.yaml
#9.EndorsePolicy 1ofeachOrg = 0, 0org&Anyotherorg, 1-N/2orgs&N/2-Norgs
for q in 0 
do
 #cp /home/ubuntu/FabricLab/hyperledger/roles/metrics_config/templates/${q}.yaml.j2 /home/ubuntu/FabricLab/hyperledger/roles/metrics_config/templates/fabric_ccp_network.yaml.j2
...
for R in goleveldb
do
 sed -i "s/^fabric_state_db: .*$/fabric_state_db: ${R}/" /home/ubuntu/FabricLab/inventory/blockchain/group_vars/blockchain-setup.yaml
 Z=1
